...
@RestController
@RequestMapping("/api/where-2-move-kafka")
public class Where2MoveKafkaResource {

    private final Logger log = LoggerFactory.getLogger(Where2MoveKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Where2MoveKafkaResource(KafkaProperties kafkaProperties) {
